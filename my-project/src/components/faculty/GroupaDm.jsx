...
const students = [
  ...
  {
    name: 'Er. Sanjay Bhandari',
    regNo: 'TPO',
    bgColor: 'bg-emerald-500/10',
  },
  {
    name: 'Kamlendra Singh',
    regNo: 'Student Cell Head',
...
// Main App Component
export default function GroupaDm() {
  return (
    <div
      className="
        min-h-screen w-full 
    ...
    >
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-white font-semibold mt-4 text-2xl">"Plant Name:- Kadamb"</p>
        <p className="text-green-200/90 mt-4 text-lg">
          Nature is our greatest treasure – preserve it
        </p>
      </div>
